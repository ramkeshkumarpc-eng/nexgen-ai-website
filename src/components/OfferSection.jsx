...
function OfferSection() {
  return (
    <div className="relative">
      {/* Soft outer glow — hidden on mobile to save height */}
      <div className="absolute -inset-1 sm:-inset-2 lg:-inset-3 bg-gradient-to-r from-neon-cyan/20 via-neon-blue/20 to-neon-purple/20 rounded-xl sm:rounded-2xl blur-xl opacity-0 sm:opacity-60" />

      <div className="relative rounded-lg sm:rounded-xl border border-neon-blue/15 bg-gradient-to-br from-dark-card/95 via-dark-card to-dark-card/95">
        ...
        <div className="relative p-3 sm:p-5 lg:p-6">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 mb-2 sm:mb-3">
            ...
            <span className="inline-flex items-center gap-1 px-2 sm:px-3 py-0.5 sm:py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-[10px] sm:text-xs font-semibold text-amber-400 whitespace-nowrap">
              ...
              <span className="animate-pulse">Ending Soon</span>
            </span>
          </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-3 sm:gap-4 lg:gap-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-x-3 sm:gap-x-5 gap-y-1 sm:gap-y-2 mt-1.5 sm:mt-2.5">
            ...
            <div className="flex flex-col items-center lg:items-end shrink-0 pt-0.5 sm:pt-0">
              <Link
                to="/contact"
                className="group inline-flex items-center gap-1.5 sm:gap-2 px-4 sm:px-5 lg:px-6 py-2 sm:py-2.5 rounded-lg bg-gradient-to-r from-neon-blue to-neon-purple text-white font-semibold text-[11px] sm:text-sm transition-all duration-300 hover:shadow-[0_0_25px_rgba(0,168,255,0.35)] hover:scale-105 active:scale-95"
              >
